...
const createAnnouncement = (index, announcments) => {
...
export const generateAnnouncements = (number) => Array.from({length: number}, (_, index) => (
  createAnnouncement(index + 1, number)),
);
